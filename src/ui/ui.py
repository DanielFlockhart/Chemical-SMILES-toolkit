...
class UI:
    ...
    def build_ui(self):
        ...
        self.persisent_widgets = [Icon(self.ui,os.path.join(self.docs_folder,r"images\benzene.png")),Label(self.ui,"Created by Daniel Flockhart 16/06/2023")]
        self.ui.geometry(f"{self.size[0]}x{self.size[1]}")
        self.ui.title(self.title_text)
    ...
    def build_pages(self,options):
        ...
        self.first_page = Page("Menu",self.ui,[Title(self.ui,self.title_text),Menu(self.ui,options,self.pages),*self.persisent_widgets])
